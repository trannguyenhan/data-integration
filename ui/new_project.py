...
class Ui_NewProject(object):
    ...
    def retranslateUi(self, NewProject):
        ...
        self.destinationCbx.setItemText(0, _translate("NewProject", "TXT"))
        self.destinationCbx.setItemText(1, _translate("NewProject", "CSV"))
        self.destinationCbx.setItemText(2, _translate("NewProject", "EXCEL"))
        self.destinationCbx.setItemText(3, _translate("NewProject", "XML"))
        self.destinationCbx.setItemText(4, _translate("NewProject", "JSON"))
        self.destinationCbx.setItemText(5, _translate("NewProject", "MS SQL Server"))
        self.destinationCbx.setItemText(6, _translate("NewProject", "MySQL"))
